...
public class FindMedianSortedArrays {
	...
	public static void main(String[] args) {
		...
		int [] nums2 = new int[] {9, 10, 11, 12, 13};
	...
	public static double findMedianSortedArrays(int[] nums1, int[] nums2) {
        ...
        System.out.println("first number: " + getKth(nums1, 0, nums2, 0, l));
        System.out.println("second number: " + getKth(nums1, 0, nums2, 0, r));
    ...
    private static double getKth(int[] nums1, int start1, int[] nums2, int start2, int k) {
        ...
        // if it's still within nums1.length
